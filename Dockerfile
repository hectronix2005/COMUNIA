...
# docker build -t gran_logia_de_colombia .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name gran_logia_de_colombia gran_logia_de_colombia
